...
import ContractWorkChart from './ContractWorkChart'
...
class ContractWork extends React.Component {
    ...
    savedForm = (data) => {
        ...
        if (model.gross <= 200) this.setState({ snackbar1: true })
        ...
        return (
            <Theme customTheme="custom4">
                ...
                <Snackbar
                    ...
                    onClose={this.handleSnackBarClose}
                    message={
                        'Przy 50% uzyskania kosztów obowiązuje limit kosztów w kwocie ' +
                        formatAsCurrency(this.state.model.maxExpenses) +
                        '.'
                    }
                />
                ...
                <ContractWorkChart model={this.state.model} />
            </Theme>
        )
    }
}
