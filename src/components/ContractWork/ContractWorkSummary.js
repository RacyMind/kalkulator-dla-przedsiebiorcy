            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="td_value output_expenses">
                            {formatAsCurrency(model.expenses)}
                        </td>
                    </tr>
                    <tr>
                        <td className="td_name">Podstawa opodatkowania</td>
                        <td className="td_value output_basisForTax">
                            {formatAsCurrency(Math.round(model.basisForTax))}
                        </td>
                    </tr>
                    <tr>
